...
$n_descripcion = strlen($descripcion1);   // Contamos el numero de caracteres
...
$precio = $_POST["precio"];            // Asi recogemos el email desde el formulario
    ...
    $detalles1= strip_tags($detalles);
    $n_detalles = strlen($detalles1);     // Eliminamos la etiquetas que puedan existir
...
$total_car = $n_descripcion * $n_precio * $n_detalles;    // Si alguno de ellos vale 0, $total_car valdrá 0

if ($total_car >= 1) {
    // Abrimos la conexion a la base de datos
    include("conexion.php");
    $_GRABAR_SQL = "INSERT INTO $tabla_db6 (idmusica,descripcion, precio,detalles) VALUES (null,'$descripcion','$precio','$detalles')";
