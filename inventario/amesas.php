...
$precio = $_POST["precio"];            // Asi recogemos el email desde el formulario
    ...
    $mantel = $_POST['mantel'];
    $mantel1= strip_tags($mantel);
    $n_mantel = strlen($mantel1);

    $precio_mantel = $_POST['precio_mantel'];
    $precio_mantel1 = strip_tags($precio_mantel);
    $n_precio_mantel=strlen($precio_mantel1);
...
$total_car = $n_descripcion * $n_cantidad * $n_precio * $n_mantel * $n_precio_mantel;    // Si alguno de ellos vale 0, $total_car valdrá 0

if ($total_car >= 1) {
    // Abrimos la conexion a la base de datos
    include("conexion.php");
    $_GRABAR_SQL = "INSERT INTO $tabla_db2 (idmesa,descripcion, cantidad, precio,mantel,precio_mantel) VALUES (null,'$descripcion','$cantidad','$precio','$mantel','$precio_mantel')";
