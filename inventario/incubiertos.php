...
<body>
  ...
  <div class="container">
    ...
    <div class="card text-white bg-secondary my-5 py-4 text-center">
      <div class="card-body">
        <p class="text-white m-0">EN ESTA PARTE USTED PUEDE GESTIONAR EL INVENTARIO DE CUBIERTOS </p>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-5 mb-5">
        <div class="card h-100">
          <div class="card-body">
            <h2 class="card-title">CUBIERTOS</h2>
            <p class="card-text"></p>
            <img src=".\assets\img\cutlery.png">
            ...
            <div class="col-8">
              <div class="tab-content align:center" id="nav-tabContent">
                ...
                <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                  <h2 class="card-title">Agregar cubiertos </h2>
                  <form class="" action="../inventario/acubiertos.php" method="post">
                    <div class="form-group">
                      <label for="mostrar-precio">Cubierto</label>
                      <select class="form-control" name="descripcion" id="mostrar-precio">
                            <option value="Vaso vidrio">Vaso de vidrio</option>
                            <option value="Plato pozolero">Plato pozolero</option>
                ...
                <table class="table">
                  ...
                  <tbody>
                    <?php
                      $sql = mysqli_query($conexion_db, "SELECT * FROM $tabla_db3 ");
                      $sql = mysqli_query($conexion_db, "SELECT * FROM $tabla_db3 ORDER BY idcubierto DESC");
