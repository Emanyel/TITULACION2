...
<body>
  ...
  <div class="container">
    ...
    <div class="card text-white bg-secondary my-5 py-4 text-center">
      <div class="card-body">
        <p class="text-white m-0">EN ESTA PARTE USTED PUEDE GESTIONAR EL INVENTARIO DE MESAS </p>
      </div>
    </div>
          ...
          <div class="card-body">
            <div class="col-8">
              ...
              <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                  <h2 class="card-title">Agregar mesas </h2>
                  <form class="" action="../inventario/amesas.php" method="post">
                    <div class="form-group">
                      <label for="mostrar-precio">Tipo de Mesa</label>
                      <select class="form-control" name="descripcion" id="mostrar-precio">
                            <option value="Tablón redondo">Tablón redondo</option>
                            <option value="Tablón rectangular">Tablón rectangular</option>
                      </select>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="mostrar-precio">Mantel</label>
                      <select class="form-control" name="mantel" id="mostrar-precio">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" class="form-control" name="precio_mantel" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                        </div>
                      <button type="submit" class="btn btn-outline-danger">Guardar</button>
                    </form>
                </div>
              <div class="tab-pane fade"  id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">
                <h2 class="card-title">Inventario mesas </h2>
                <?php
                include("conexion.php");
                ?>
                <div class="container">
              ...
              <table class="table">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th scope="col">Mantel</th>
                    <th scope="col">Precio Mantel</th>
                ...
                <tbody>
                  <?php
                    $sql = mysqli_query($conexion_db, "SELECT * FROM $tabla_db2 ");
                    $sql = mysqli_query($conexion_db, "SELECT * FROM $tabla_db2 ORDER BY idmesa DESC");
              ...
              <button onclick="javascript:window.location.reload();" ><img src=".\assets\img\refresh.png"> </button>
                ...
                <div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">
                  <h2 class="card-title">Eliminar mesas </h2>
                  <div class="input-group input-group-sm mb-3">
                      <div class="input-group-prepend">
